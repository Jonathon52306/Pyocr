...
def oss_upload(osspath,localpath,filename):
    ...
    auth = oss2.Auth('LTAI4FphrG1wCQQzRo9hzrJm', 'ffzrVFvfkzhQdgWPgEX1fciMDLSwtj')
    bucket = oss2.Bucket(auth, 'http://oss-cn-beijing.aliyuncs.com', 'image-jonathon')
    bucket.put_object_from_file(osspath, localpath)
    img_url = 'https://image-jonathon.oss-cn-beijing.aliyuncs.com/img/' + filename
    print("Done.")
    return img_url
